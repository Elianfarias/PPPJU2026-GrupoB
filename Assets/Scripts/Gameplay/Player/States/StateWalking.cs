...
public class StateWalking : StateBase
{
    ...
    private void ApplyMovement()
    {
        ...
        Vector3 targetVelocity = worldDirection * (PlayerContext.Data.MaxHorizontalSpeed / 2);

        Vector3 currentHorizontal = new(PlayerContext.Rb.linearVelocity.x, 0f, PlayerContext.Rb.linearVelocity.z);
        Vector3 newHorizontal = Vector3.MoveTowards(currentHorizontal, targetVelocity, (PlayerContext.Data.Acceleration / 2) * Time.fixedDeltaTime);
